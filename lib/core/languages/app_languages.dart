...
/// Callers can lookup localized strings with an instance of Languages
/// returned by `Languages.of(context)`.
///
/// Applications need to include `Languages.delegate()` in their app's
...
/// be consistent with the languages listed in the Languages.supportedLocales
/// property.
...
class _LanguagesDelegate extends LocalizationsDelegate<Languages> {
  ...
  Future<Languages> load(Locale locale) {
    return SynchronousFuture<Languages>(lookupLanguages(locale));
  }
...
Languages lookupLanguages(Locale locale) {
  ...
  throw FlutterError(
    'Languages.delegate failed to load unsupported locale "$locale". This is likely '
