...
class MobileTripWidget extends StatelessWidget {
  final Trip trip;
  const MobileTripWidget({super.key, required this.trip});
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.keyboard_arrow_down_sharp, size: 16),
                        ],
                      ),
                    ),
                    SizedBox(height: 18),
                    ...
                    UsersImages(
                      ...
                      width: context.responsiveUI == ResponsiveUI.mobile
                          ? 244
                          : 343,
                    ),
                  ],
